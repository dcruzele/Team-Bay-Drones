...
% M. Streﬂer, R. Carrasco and J. Horstmann, "Video-Based Estimation 
...
IMG_SEQ_Window = double(IMG_SEQ.IMG(STCFIT.Windows.w_corners_dim1(2,n_window):STCFIT.Windows.w_corners_dim1(3,n_window), STCFIT.Windows.w_corners_dim2(2,n_window):STCFIT.Windows.w_corners_dim2(3,n_window),:));
...
h_ann_1 = annotation('textbox', pos_ann_1, 'String', str_ann,'FontWeight','Bold', 'HorizontalAlignment','center','VerticalAlignment','middle');
...
h_ann_2 = annotation('textbox', pos_ann_2, 'String', str_ann,'FontWeight','Bold', 'HorizontalAlignment','center','VerticalAlignment','middle');
...
h_ann_3 = annotation('textbox', pos_ann_3, 'String', str_ann,'FontWeight','Bold', 'HorizontalAlignment','center','VerticalAlignment','middle');
...
h_ann_4 = annotation('textbox', pos_ann_4, 'String', str_ann,'FontWeight','Bold', 'HorizontalAlignment','center','VerticalAlignment','middle');
...
h.UserData = struct('Spectrum',Spectrum,'K_cut',K_cut,'W_cut',W_cut, 'water_depth',water_depth,'Ux',Ux,'Uy',Uy,'w_cut_dir',w_cut_dir, 'w_width',w_width,'out_fit',out_fit,'ax',ax,'h_ann_1',h_ann_1, 'h_ann_2',h_ann_2,'h_ann_3',h_ann_3,'h_ann_4',h_ann_4, 'fit_param',STCFIT.fit_param);
...
h_sc1 = uicontrol('style','slider', 'units','normalized','position',ypos_sc1, 'callback',clbk_sc1,'min',ymin_sc1,'max',ymax_sc1, 'value',h.UserData.w_width,'SliderStep', [1/40 , 0.25]);    
...
h_sc2 = uicontrol('style','slider', 'units','normalized','position',ypos_sc2, 'callback',clbk_sc2,'min',ymin_sc2,'max',ymax_sc2, 'value',h.UserData.w_cut_dir,'SliderStep', [1/360 , 1/4]);    
...
h_sc3 = uicontrol('style','slider', 'units','normalized','position',ypos_sc3, 'callback',clbk_sc3,'min',ymin_sc3,'max',ymax_sc3, 'value',h.UserData.Uy,'SliderStep', [1/120 , 1/12]);    
...
h_sc4 = uicontrol('style','slider', 'units','normalized','position',ypos_sc4, 'callback',clbk_sc4,'min',ymin_sc4,'max',ymax_sc4, 'value',h.UserData.Ux,'SliderStep', [1/120 , 1/12]);    
...
h_sc5 = uicontrol('style','pushbutton', 'units','normalized','position',ypos_sc5, 'callback',clbk_sc5,'String', 'FIT');  
