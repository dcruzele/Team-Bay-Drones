function STCFIT = generate_STCFIT_from_IMG_SEQ(IMG_SEQ, sq_size_m, sq_dist_m, mask_2D,nan_percentage_thr,water_depth_mask_2D,Ux_limits_FG, Uy_limits_FG,U_FG_res, w_width_FG,U_SG_res,w_width_SG,waveLength_limits_m, wavePeriod_limits_sec)
...
load('run_Georeference_Struct_config','IMG_SEQ')
...
Generic = struct('gridX',IMG_SEQ.gridX,'gridY',IMG_SEQ.gridY,'image',image,'Longitude',IMG_SEQ.Longitude,'Latitude',IMG_SEQ.Latitude,'heading',IMG_SEQ.heading, 'altitude',IMG_SEQ.altitude,'time_stamp',IMG_SEQ.ts_video, 'usable_data_mask_2D',usable_data_mask_2D, 'water_depth_mask_2D',water_depth_mask_2D);
...
Windows = struct('N_fit_windows',N_fit_windows,'w_corners_dim1',w_corners_dim1, 'w_corners_dim2',w_corners_dim2,'sq_size_m', sq_size_m, 'sq_dist_m',sq_dist_m,'average_depth_win',average_depth_win);
...
fit_param = struct('Ux_FG_2D',Ux_FG_2D,'Uy_FG_2D',Uy_FG_2D,'w_width_FG',w_width_FG,'w_width_SG',w_width_SG, 'waveLength_limits_m',waveLength_limits_m,'wavePeriod_limits_sec', wavePeriod_limits_sec,'K_limits',K_limits,'W_limits',W_limits);
