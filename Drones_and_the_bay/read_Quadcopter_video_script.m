...
%%video_fname = VideoReader('E:\MATLAB')
...
[LON_drone,LAT_drone,Height_GPS_drone,timestamp_video, mediainfo_string, heading,pitch,roll] = get_mediainfo_information_mavicmini(video_fname);     
