function [calibrated_FOV_diag,size_frame, CopterCurrents_CamCalib ] = calibration_FOV(video_fname,real_distance,time_frame_sec, Height_offset,camera_offset_Z,CopterCurrents_calibration_filename,Height_GPS_drone)
