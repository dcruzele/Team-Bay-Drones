function [CamPos_ST] = get_Camera_Position_Struct_mavicmini(video_filename)
...
CamPos_ST = struct('LONGITUDE',LON,'LATITUDE',LAT,'Height',Height, 'timestamp',timestamp,'yaw',yaw,'pitch',pitch,'roll',roll,'extra',mediainfo_string);
