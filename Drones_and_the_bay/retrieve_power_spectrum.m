...
Spectrum = struct('power_Spectrum',power_Spectrum_cut, 'Kx_3D',Kx_3D,'Ky_3D',Ky_3D,'W_3D',W_3D, 'dKx',dKx,'dKy',dKy,'dW',dW, 'Kx_orig_limits',Kx_orig_limits,'Ky_orig_limits', Ky_orig_limits,'W_orig_limits',W_orig_limits);
