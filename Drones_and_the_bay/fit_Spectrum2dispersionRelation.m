...
FG_fit =  struct('signal_2D',signal_FG_2D,'noise_2D',noise_FG_2D, 'signal_nvalues_2D',signal_nvalues_2D,'noise_nvalues_2D',noise_nvalues_2D, 'SNR_2D',SNR_FG,'SNR_density_2D',SNR_density_FG, 'Ux_fit',Ux_fit_FG,'Uy_fit',Uy_fit_FG, 'SNR_max',SNR_FG_max,'SNR_density_max',SNR_density_FG_max, 'Ux_2D',fit_param.Ux_FG_2D,'Uy_2D',fit_param.Uy_FG_2D);
...
SG_fit =  struct('signal_2D',signal_SG_2D,'noise_2D',noise_SG_2D, 'signal_nvalues_2D',signal_nvalues_2D,'noise_nvalues_2D',noise_nvalues_2D, 'SNR_2D',SNR_SG,'SNR_density_2D',SNR_density_SG, 'Ux_fit',Ux_fit_SG,'Uy_fit',Uy_fit_SG, 'SNR_max',SNR_SG_max,'SNR_density_max',SNR_density_SG_max, 'Ux_2D',Ux_SG_2D,'Uy_2D',Uy_SG_2D);
