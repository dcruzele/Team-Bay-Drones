function [STCFIT] = run_current_fit(IMG_SEQ,STCFIT) %STCFIT
...
for i1 = 1:STCFIT.Windows.N_fit_windows
    ...
    IMG_SEQ_Window = double(IMG_SEQ.IMG(STCFIT.Windows.w_corners_dim1(2,i1):STCFIT.Windows.w_corners_dim1(3,i1), STCFIT.Windows.w_corners_dim2(2,i1):STCFIT.Windows.w_corners_dim2(3,i1),:));
