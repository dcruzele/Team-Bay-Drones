function [img_monotonic_grid,conv_monotonic_grid_ST,grid_X_RW_2d,grid_Y_RW_2d] = georeferenceDJIFrame_byCaltech_EQ_v2(img,altitude,pitch,roll,CopterCurrents_CamCalib)
...
[xp] = project_points2(X,om,T, CopterCurrents_CamCalib.fc,CopterCurrents_CamCalib.cc,CopterCurrents_CamCalib.kc,CopterCurrents_CamCalib.alpha_c);
...
conv_monotonic_grid_ST =  struct('LinearInd_grid',LinearInd_grid, 'LinearInd_img',LinearInd_img,'grid_d1_RW_2d',grid_d1_RW_2d, 'grid_d2_RW_2d',grid_d2_RW_2d,'size_original_image', size_original_image,'dxdy',dxdy);
