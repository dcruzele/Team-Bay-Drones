...
while ishghandle(h_fig) && maximum_n_measures> 0
    ...
    if maximum_n_measures ~= 1
        ...
        title({['distance: ' num2str(distance,'%.3f')   '   distanceX: ' num2str(distance_x,'%.3f')  '   distanceY: ' num2str(distance_y,'%.3f')], ['Press SPACER to continue or  CLOSE FIGURE + SPACER to finish.']});

    else

        title({['distance: ' num2str(distance,'%.3f')   '   distanceX: '  num2str(distance_x,'%.3f')  '   distanceY: '  num2str(distance_y,'%.3f')], ['Press SPACER to continue']});
